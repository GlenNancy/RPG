...
namespace RpgMvc.Controllers
{
    ...
    {
        public string uriBase = "http://glennancy.somee.com/RpgApi/Disputas/";
        ...
        public async Task<ActionResult> IndexAsync()
        {
            try
            {
                ...
                string uriBuscarPersonagens = "http://glennancy.somee.com/RpgApi/Personagens/GetAll";
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                string uriBuscaHabilidades = "http://glennancy.somee.com/RpgApi/PersonagemHabilidades/GetHabilidades";
        ...
        public async Task<ActionResult> DisputaGeralAsync()
        {
            try
            {
                ...
                string uriBuscaPersonagens = "http://glennancy.somee.com/RpgApi/Personagens/GetAll";
                ...
                string uriDisputa = "http://glennancy.somee.com/RpgApi/Disputas/DisputaEmGrupo";
